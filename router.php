...
final class Router
{
	...
	private const CUSTOM_ERROR_LOG_PATH = '.custom-logs/.error.log';
	...
	private static function logError(Throwable $exception): void
	{
		...
		error_log($currentDateTime, 3, self::CUSTOM_ERROR_LOG_PATH);
		error_log($currentAgentIp,  3, self::CUSTOM_ERROR_LOG_PATH);
		error_log($exception,       3, self::CUSTOM_ERROR_LOG_PATH);
		error_log($endOfLine,       3, self::CUSTOM_ERROR_LOG_PATH);
	...
	public static function run()
	{
		...
		*/
		...
		else if ($routeCount === 3 && $routes[2] === 'font-test-page')
		{
