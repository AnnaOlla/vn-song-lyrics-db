...
namespace Localization\PolicyPage
{
	...
	const ContentPolicy9  = '9. При копировании любой части контента сайта пользователю рекомендуется дать ссылку на веб-сайт и указать автора работы.';
	const ContentPolicy10 = '10. Пользователь не имеет права копировать, изменять, брать за основу или использовать любую часть контента сайта без ссылки на страницу и автора работы.';
	const ContentPolicy11 = '11. Политика может быть изменена без уведомления пользователей.';
	...
	const LastUpdated        = 'Последнее изменение: 07 мая 2026.';
