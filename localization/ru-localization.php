...
namespace Localization\PolicyPage
{
	...
	const ContentPolicy2  = '2. Наименования игр и игровых персонажей, исполнителей и альбомов, а также все изображения собраны из разных источников и могут быть объектом прав их соответствующих правообладателей.';
