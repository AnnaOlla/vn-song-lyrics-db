...
namespace Localization\RulesPage
{
	...
	const GeneralRule4  = '4. В базу данных вносятся официальные издания и фанатские работы. Так называемые «gamerip» не разрешены.';
	...
	const GeneralRule7c = '.';
	const GeneralRule8  = '8. Любое нежелательное поведение, не попадающее под правила выше, может быть приравнено к нарушению.';
	const GeneralRule9  = '9. Администрация сайта оставляет за собой право ограничивать доступ к ресурсу полностью или только часть функционала любого пользователя без объяснения причин и уведомлений.';
